...
from chess.views.utils import navigate_to_button
...
class LocalChessGameView(ScreenFormBaseNew):
    ...
    def create(self):
        self.start = navigate_to_button(self, 'Go', MainView)

    def on_enter(self):
        self.game_controller = self.controller.create_local_game()
